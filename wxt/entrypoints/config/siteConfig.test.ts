...
describe('siteConfig', () => {
  it('has all required URL properties defined as valid URLs', () => {
    ...
    expect(siteConfig.adsUrl).toBe('https://github.com/3y3y3y-huaiji/MicrosoftRewardsWebsite#sponsor');
    expect(siteConfig.privacyUrl).toBe('https://github.com/3y3y3y-huaiji/MicrosoftRewardsWebsite#privacy');
